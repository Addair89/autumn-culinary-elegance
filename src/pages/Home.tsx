    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="relative container mx-auto px-6 text-center text-white">
          <h1 className="text-white animate-fade-up mb-6 text-5xl md:text-7xl font-display font-bold">
            Personal Chef Service
          </h1>
          <p className="text-salmon-light animate-fade-up-delay mb-4 max-w-3xl mx-auto text-xl md:text-2xl font-medium">
            Tucson's Answer for Made To Order Eclectic Cuisine
          </p>
          <p className="text-white/90 animate-fade-up-delay mb-8 max-w-3xl mx-auto text-lg">
